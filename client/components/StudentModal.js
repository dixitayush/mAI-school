            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                        <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-2">Student Information</h3>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="pl-10 w-full px-3 py-2 border border-zinc-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all outline-none"
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                disabled={!!student}
                                className="pl-10 w-full px-3 py-2 border border-zinc-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent disabled:bg-zinc-100 transition-all outline-none"
                                placeholder="johndoe"
                            />
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-2 pt-4">
                        <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-2">Parent Information</h3>
                        <div className="h-px bg-zinc-200"></div>
                    </div>
                ...
                <div className="flex space-x-3 pt-4 border-t border-zinc-100 mt-6">
                    <button
                        type="button"
                        onClick={onClose}
