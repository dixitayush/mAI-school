                    ...
                    <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-100 px-8 py-4 flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-6">
                            ...
                            <div className="flex items-center space-x-3 pl-6 border-l border-gray-200">
                                ...
                                <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-primary-500 to-indigo-500 p-0.5 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
