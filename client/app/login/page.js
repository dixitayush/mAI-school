  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:5001"}/login`,
        {
          method: "POST",
        ...
        <motion.div {...motionProps} className="w-full max-w-[420px]">
          <div className="mb-8 text-center">
            <motion.div
              ...
              className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 shadow-lg shadow-primary-500/30 ring-4 ring-white"
            >
