    ...
    return (
        <ApolloWrapper>
            <div className="min-h-screen bg-gray-50 flex font-sans text-gray-900">
                ...
                <NotificationListener userRole="teacher" />
                        ...
                        <div className="flex items-center space-x-6">
                            ...
                            <div className="flex items-center space-x-3 pl-6 border-l border-gray-200">
                                <div className="text-right hidden sm:block">
                                    <p className="text-sm font-semibold text-gray-900">{user?.full_name || 'Teacher'}</p>
                                    <p className="text-xs text-gray-500">Educator</p>
                                </div>
                                <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 p-0.5 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
